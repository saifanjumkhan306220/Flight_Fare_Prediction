...
X1 = data_train1.loc[:,['Total_Stops', 'Journey_day', 'Journey_month', 'Dep_hour',
       'Dep_min', 'Arrival_hour', 'Arrival_min', 'Duration_hours',
       'Duration_mins', 'Airline_IndiGo',
       'Airline_Jet Airways','Airline_Air India',
       'Airline_Multiple carriers', 'Source_Delhi',
       'Destination_Cochin', 'Destination_New Delhi',"Source_Mumbai",'Destination_Hyderabad','Airline_SpiceJet','Airline_Jet Airways Business',]]
...
model_comparison['Linear Regression']=[r2_score(y_test,y_pred),mean_squared_error(y_test,y_pred),mean_absolute_error(y_test,y_pred),np.sqrt(metrics.mean_squared_error(y_test,y_pred))]


# In[44]:


# Visualize the predicted vs. actual values along with the linear regression line
